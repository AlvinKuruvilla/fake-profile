...
class Verifiers:
    def __init__(self, p1, p2, pattern1_threshold=5, pattern2_threshold=2):
        ...
        self.pattern1threshold = (
            pattern1_threshold  # sort of feature selection, if we dont have
        )
        self.pattern2threshold = (
            pattern2_threshold  # sort of feature selection, if we dont have
        )
        ...
        print(
            f"comparing {len(self.common_features)} common_features between the reference and the probe"
        )
